...
public class DetailCalegAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_caleg_admin);
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                try {
                    ...
                    String foto = "http://156.67.221.225/voting/dashboard/save/foto_caleg/" + calegData.getString(1);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_edit){
            startActivity(new Intent(getApplicationContext(), EditData.class));
            return true;
        }
