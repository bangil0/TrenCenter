...
import com.tren.trencenter.adapter.PlatformAdapter;
import com.tren.trencenter.app.AppConfig;
import com.tren.trencenter.app.AppController;
import com.tren.trencenter.listener.PlatformListener;
import com.tren.trencenter.model.PlatformModel;
...
public class DetailPenghargaanAdmin extends AppCompatActivity implements PlatformListener.RecyclerItemTouchHelperListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_penghargaan_admin);
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        PlatformModel platformItem = platform.get(position);
        String old = platformItem.getPlatform();

        Intent intent = new Intent(getApplicationContext(), EditPenghargaan.class);
